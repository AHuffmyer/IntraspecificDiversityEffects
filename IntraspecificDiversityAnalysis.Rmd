...
```{r}
wilcox.test(SOD~genotype,data=activity)
```
...
bwt_analysis%>%
  unite("code", c("Temperature", "Treatment", "Genotype"))%>%
  bartlett.test(TotalPercentDay~code, data=.)

bwt_analysis%>%
  unite("code", c("Temperature", "Treatment", "Genotype"))%>%
  leveneTest(TotalPercentDay~code, data=.)
...
pam_analysis%>%
  unite("code", c("Temperature", "Treatment", "Genotype"))%>%
  bartlett.test(Change~code, data=.)

pam_analysis%>%
  unite("code", c("Temperature", "Treatment", "Genotype"))%>%
  leveneTest(Change~code, data=.)
``` 
