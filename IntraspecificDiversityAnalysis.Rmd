...
Add genotype as a random effect to account for repeated measures. **This is the model we will use for final analysis**   
```{r}
...
**This is the model we will use for final analysis**   
...
Conduct linear mixed effect model to analyze the effect of temperature treatment, diversity, and genotype on growth. **This is the model we will use for final analysis**   
