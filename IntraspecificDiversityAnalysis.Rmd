...
#ggsave("Figures/Larval_Surv_Treatment.pdf", plot=larv_surv_plot_trt, height=4, width=6, units = c("in"), dpi=300) #output figure
```
...
#ggsave("Figures/Larval_Settle_Treatment.pdf", plot=larv_settle_plot_trt, height=4, width=6, units = c("in"), dpi=300) #output figure
```
## 4. Analysis  
...
#ggsave("Figures/Adult_Surv_Treatment.pdf", plot=surv_plot_trt, height=4, width=4, units = c("in"), dpi=300) #output figure
```
...
#ggsave("Figures/Adult_bwt_treatment.pdf", plot=bwt_plot_trt, height=4, width=6, units = c("in"), dpi=300) #output figure
```
...
#ggsave("Figures/Adult_PAM_trt.pdf", plot=pam_plot_trt, height=4, width=6, units = c("in"), dpi=300) #output figure
```
...
leveneTest(residuals(model_pam_trt)~Temperature*Treatment, data=pam_analysis)
``` 
